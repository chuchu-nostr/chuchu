...
class CommonImageGallery extends StatefulWidget {
  ...
  static show({
    ...
    context ??= ChuChuNavigator.navigatorKey.currentContext;
    if (context == null) return ;

    ChuChuNavigator.pushPage(context, (context) => CommonImageGallery(
      imageList: imageList,
      initialPage: initialPage,
    ), type: ChuChuPushPageType.opacity);
  }
}
...
class _CommonImageGalleryState extends State<CommonImageGallery>
                    ...
                    children: <Widget>[
                      new GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'scan_qr_code',
                            style: new TextStyle(color: Colors.red, fontSize: Adapt.px(16), fontWeight: FontWeight.normal),
                          ),
                        ),
                      ),
                      Divider(
  ...
  Color _slidePageBackgroundHandler(Offset offset, Size pageSize) {
    ...
    return Colors.black54.withOpacity(min(1.0, max(1.0 - opacity, 0.0)));
  }
