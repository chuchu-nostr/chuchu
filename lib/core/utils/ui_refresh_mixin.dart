...
mixin ChuChuUIRefreshMixin<T extends StatefulWidget> on State<T> {
...
mixin ChuChuUIRefreshKeepAliveMixin<T extends StatefulWidget> on AutomaticKeepAliveClientMixin<T> {
