...
import 'feed_content_analyze_utils.dart';
class FeedUtils {
  ...
  static String formatTimestamp(int timestamp) {
    ...
    String formattedDate = "${twoDigits(date.month)}/${twoDigits(date.day)}";
  ...
  static List<String> momentContentSplit(String input) {
    ...
    RegExp noteExp = FeedContentAnalyzeUtils.regexMap['noteExp'] as RegExp;
    RegExp naddrExp = FeedContentAnalyzeUtils.regexMap['naddrExp'] as RegExp;
    // RegExp lightningInvoiceExp =
    // FeedContentAnalyzeUtils.regexMap['lightningInvoiceExp'] as RegExp;
    // RegExp ecashExp = FeedContentAnalyzeUtils.regexMap['ecashExp'] as RegExp;
